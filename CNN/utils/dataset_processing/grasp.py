...
class Grasp:
    ...
    def plot(self, ax, offset_val, color=None):
        """
        Plot Grasp
        :param ax: Existing matplotlib axis
        :param color: (optional) color
        """
        self.as_gr.plot(ax, color, offset_val)
...
def detect_grasps(q_img, ang_img, width_img=None, no_grasps=1):
    ...
    local_max = peak_local_max(q_img, min_distance=20, threshold_abs=0.25, num_peaks=no_grasps)
    #print(local_max)
    grasps = []
