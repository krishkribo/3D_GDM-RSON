 # G_GDM end-end pipeline
'''
input -> point cloud data/ point cloud - file source
output -> grasp detection, GDM learning (using trained models) 
'''
import os
import sys
...
if __name__ == '__main__':
	...
	run_rt(data=[working_dir+'/'+pcl_folder+'/'+f for f in file], e_network='batch_res_tc/exp_0_tc/e_net_batch_tc', 
		s_network='batch_res_tc/exp_0_tc/s_net_batch_tc', d_flag=True, r_flag=True, n_grasp=2, m_name='n_model_4', min_dist=5)