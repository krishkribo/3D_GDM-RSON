...
bool BoundingBoxServer::transformPointCloudMessageToLink(sensor_msgs::PointCloud2 &point_cloud_message,
  ...
  transformPointCloud(transform_to_link, point_cloud_message, transformed_point_cloud_message, transform_listener_);
  return true;
} 


bool BoundingBoxServer::transformPointCloud (const std::string &target_frame, const sensor_msgs::PointCloud2 &in, 
...
void BoundingBoxServer::transformPointCloud (const Eigen::Matrix4f &transform, const sensor_msgs::PointCloud2 &in,
...
void BoundingBoxServer::transformAsMatrix (const tf::Transform& bt, Eigen::Matrix4f &out_mat)
{
  double mv[12];
