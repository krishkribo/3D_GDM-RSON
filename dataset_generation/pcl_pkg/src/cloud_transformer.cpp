...
public:
    ...
    : nh_(nh)
  {
    ...
    buffer_->header.frame_id = "new_frame_id";
  }
...
private:
  ...
  {
    listener_.waitForTransform("new_frame_id", "kinect_link", ros::Time::now(), ros::Duration(3.0));
    pcl_ros::transformPointCloud("new_frame_id", *pcl_msg, *buffer_, listener_);
