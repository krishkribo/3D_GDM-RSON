...
// create a pcl object to hold the passthrough filtered results
  ...
  pass.setFilterLimits ((xyzCloudPtrFiltered->points[inliers->indices[0]].x +0.0 ), (xyzCloudPtrFiltered->points[inliers->indices[0]].x  + 0.8));
pass.setFilterFieldName ("y");
  pass.setFilterLimits ((xyzCloudPtrFiltered->points[inliers->indices[0]].y -0.5 ), (xyzCloudPtrFiltered->points[inliers->indices[0]].y  + 0.35));
