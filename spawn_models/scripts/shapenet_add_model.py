...
if __name__ == '__main__':
    ...
    models = []
    model_dir = os.listdir("/home/krish/project_workspace/workspace3/src/spawn_models/models/shapenet_models")
    for m in model_dir:
        if os.path.isfile("/home/krish/project_workspace/workspace3/src/spawn_models/models/shapenet_models/"+m):
